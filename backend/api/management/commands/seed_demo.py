...
ASSETS_DATA = [
    # Laptops
    {
        ...
        'serial_number': 'DLTG5540-001', 'manufacturer': 'Dell', 'model': 'Latitude 5540', 'supplier': 'CDW',
        ...
        'operating_system': 'Windows 11 Pro', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-002', 'category': 'Laptop', 'status': 'DEPLOYED',
        'serial_number': 'DLTG5540-002', 'manufacturer': 'Dell', 'model': 'Latitude 5540', 'supplier': 'CDW',
        'purchase_date': date(2023, 4, 10), 'purchase_cost': 1349.00,
        'warranty_expiry': date(2026, 4, 10),
        'cpu': 'Intel Core i7-1355U', 'ram': '16 GB', 'storage_size': '512 GB SSD',
        'operating_system': 'Windows 11 Pro', 'assigned_to_name': 'Lebron Jeymz',
    },
    {
        'asset_tag': 'ES-005', 'category': 'Laptop', 'status': 'AVAILABLE',
        'serial_number': 'MBP16M3-001', 'manufacturer': 'Apple', 'model': 'MacBook Pro 16"', 'supplier': 'Apple Store',
        ...
        'operating_system': 'macOS Sonoma', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-006', 'category': 'Laptop', 'status': 'DEPLOYED',
        'serial_number': 'TPX1C5GEN-001', 'manufacturer': 'Lenovo', 'model': 'ThinkPad X1 Carbon Gen 11', 'supplier': 'Insight',
        ...
        'operating_system': 'Windows 11 Pro', 'assigned_to_name': 'Ronald MacDonald',
    },
    {
        'asset_tag': 'ES-009', 'category': 'Laptop', 'status': 'AVAILABLE',
        'serial_number': 'HPELITEX360-001', 'manufacturer': 'HP', 'model': 'EliteBook x360 1040 G10', 'supplier': 'CDW',
    ...
    },
    {
        ...
        'serial_number': 'TPX1C5GEN-002', 'manufacturer': 'Lenovo', 'model': 'ThinkPad X1 Carbon Gen 10', 'supplier': 'Insight',
    ...
    },
    {
        ...
        'serial_number': 'ZENBOOKPRO-001', 'manufacturer': 'ASUS', 'model': 'ZenBook Pro 15 OLED', 'supplier': 'Amazon Business',
        ...
        'operating_system': 'Windows 11 Home', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-016', 'category': 'Laptop', 'status': 'AVAILABLE',
        'serial_number': 'SURFACE-PRO9-001', 'manufacturer': 'Microsoft', 'model': 'Surface Laptop 5', 'supplier': 'Microsoft Store',
    ...
    },
    {
        ...
        'serial_number': 'MBP16M3-002', 'manufacturer': 'Apple', 'model': 'MacBook Pro 16"', 'supplier': 'Apple Store',
        ...
        'operating_system': 'macOS Sonoma', 'assigned_to_name': 'Priya Nair',
    },
    {
        'asset_tag': 'ES-019', 'category': 'Laptop', 'status': 'AVAILABLE',
        'serial_number': 'HPSPEC360-001', 'manufacturer': 'HP', 'model': 'Spectre x360 16', 'supplier': 'Insight',
    ...
    # Phones
    {
        ...
        'serial_number': 'IP15PRO-001', 'manufacturer': 'Apple', 'model': 'iPhone 15 Pro', 'supplier': 'Apple Store',
        'purchase_date': date(2023, 9, 25), 'purchase_cost': 999.00,
        'warranty_expiry': date(2025, 9, 25),
        'imei_number': '356938035643809', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-004', 'category': 'Phone', 'status': 'DEPLOYED',
        'serial_number': 'GS24-001', 'manufacturer': 'Samsung', 'model': 'Galaxy S24', 'supplier': 'CDW',
        'purchase_date': date(2024, 1, 20), 'purchase_cost': 799.00,
        'warranty_expiry': date(2026, 1, 20),
        'imei_number': '490154203237518', 'assigned_to_name': 'Stephen Carry',
    },
    {
        'asset_tag': 'ES-008', 'category': 'Phone', 'status': 'AVAILABLE',
        'serial_number': 'IP15PRO-002', 'manufacturer': 'Apple', 'model': 'iPhone 15 Pro', 'supplier': 'Apple Store',
        'purchase_date': date(2023, 9, 25), 'purchase_cost': 999.00,
        'warranty_expiry': date(2025, 9, 25),
        'imei_number': '356938035643810', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-015', 'category': 'Phone', 'status': 'AVAILABLE',
        'serial_number': 'GS24-002', 'manufacturer': 'Samsung', 'model': 'Galaxy S24', 'supplier': 'CDW',
        'purchase_date': date(2024, 1, 20), 'purchase_cost': 799.00,
        'warranty_expiry': date(2026, 1, 20),
        'imei_number': '490154203237519', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-018', 'category': 'Phone', 'status': 'LOST',
        'serial_number': 'GS23U-001', 'manufacturer': 'Samsung', 'model': 'Galaxy S23 Ultra', 'supplier': 'CDW',
        'purchase_date': date(2022, 3, 10), 'purchase_cost': 749.00,
        'warranty_expiry': date(2024, 3, 10),
        'imei_number': '356938035643811', 'assigned_to_name': None,
        'notes': 'Reported lost during offsite in Q4 2023. Police report filed.',
    },
    {
        'asset_tag': 'ES-021', 'category': 'Phone', 'status': 'AVAILABLE',
        'serial_number': 'IP15-001', 'manufacturer': 'Apple', 'model': 'iPhone 15', 'supplier': 'Apple Store',
        'purchase_date': date(2023, 9, 25), 'purchase_cost': 799.00,
        'warranty_expiry': date(2025, 9, 25),
        'imei_number': '356938035643812', 'assigned_to_name': None,
    },
    # Tablets
    {
        'asset_tag': 'ES-010', 'category': 'Tablet', 'status': 'DEPLOYED',
        'serial_number': 'IPADPRO12-001', 'manufacturer': 'Apple', 'model': 'iPad Pro 12.9"', 'supplier': 'Apple Store',
        'purchase_date': date(2023, 5, 3), 'purchase_cost': 1099.00,
        'warranty_expiry': date(2025, 5, 3),
        'assigned_to_name': 'Maria Chen',
    },
    {
        'asset_tag': 'ES-011', 'category': 'Tablet', 'status': 'AVAILABLE',
        'serial_number': 'SURFPRO9-001', 'manufacturer': 'Microsoft', 'model': 'Surface Pro 9', 'supplier': 'Microsoft Store',
    ...
    },
    {
        ...
        'serial_number': 'IPADAIR5-001', 'manufacturer': 'Apple', 'model': 'iPad Air 5th Gen', 'supplier': 'Apple Store',
    ...
    # Monitors
    {
        ...
        'serial_number': 'LGUL27-001', 'manufacturer': 'LG', 'model': 'UltraGear 27GP850-B', 'supplier': 'Insight',
        'purchase_date': date(2022, 10, 1), 'purchase_cost': 349.00,
        'warranty_expiry': date(2025, 10, 1),
        'screen_size': '27"', 'assigned_to_name': 'James Chen',
    },
    {
        'asset_tag': 'ES-MON-002', 'category': 'Monitor', 'status': 'AVAILABLE',
        'serial_number': 'DELU2722D-001', 'manufacturer': 'Dell', 'model': 'UltraSharp U2722D', 'supplier': 'CDW',
        'purchase_date': date(2023, 1, 5), 'purchase_cost': 399.00,
        'warranty_expiry': date(2026, 1, 5),
        'screen_size': '27"', 'assigned_to_name': None,
    },
    {
        'asset_tag': 'ES-MON-003', 'category': 'Monitor', 'status': 'IN_MAINTENANCE',
        'serial_number': 'LGUL32-001', 'manufacturer': 'LG', 'model': 'UltraGear 32GP850-B', 'supplier': 'Insight',
        'purchase_date': date(2021, 8, 20), 'purchase_cost': 599.00,
        'warranty_expiry': date(2024, 8, 20),
        'screen_size': '32"', 'assigned_to_name': None,
        'notes': 'Backlight flickering. Scheduled for RMA.',
    },
    # PCs
    {
        'asset_tag': 'ES-007', 'category': 'PC', 'status': 'AVAILABLE',
        'serial_number': 'DELLPREC3680-001', 'manufacturer': 'Dell', 'model': 'Precision 3680', 'supplier': 'CDW',
    ...
    },
    {
        ...
        'serial_number': 'MACPROM2-001', 'manufacturer': 'Apple', 'model': 'Mac Pro (M2 Ultra)', 'supplier': 'Apple Store',
    ...
    # Other
    {
        ...
        'serial_number': 'PIXEL7A-001', 'manufacturer': 'Google', 'model': 'Pixel 7a', 'supplier': 'CDW',
    ...
    },
    {
        ...
        'serial_number': 'DELLPREC3680-002', 'manufacturer': 'Dell', 'model': 'Precision 3680', 'supplier': 'CDW',
        'purchase_date': date(2023, 5, 10), 'purchase_cost': 1899.00,
        'warranty_expiry': date(2026, 5, 10),
